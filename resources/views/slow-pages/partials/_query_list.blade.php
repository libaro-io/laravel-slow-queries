<?php /** @var  \Illuminate\Support\Collection<int, Libaro\LaravelSlowQueries\Models\SlowQuery> $slowQueries */ ?>
<div class="overflow-hidden bg-white shadow sm:rounded-md  {{$classes ?? ''}}">
    <ul role="list" class="divide-y divide-gray-200">

        @foreach($slowQueries as $slowQuery)
            <li >
                <div class="flex items-center px-4 py-4 sm:px-6 collapsible-sub relative">
